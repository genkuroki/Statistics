...
以下の定義もどれも両側検定の場合になっている. __検定は, 通常, 両側検定を使用する.__
...
統計的検定法では, 第一種の過誤の確率＝有意水準をある小さな値に定めたとき, 第二種の過誤の確率を小さくしたい.
