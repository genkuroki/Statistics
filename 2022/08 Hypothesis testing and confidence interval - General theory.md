...
この手続きを __検定__ もしくは __仮説検定__ (test, testing, hypothesis testing)と呼んだりする.  (P値が有意水準 $\alpha$ 以上になるとき, 「__受容__ (accept)された」ということがあるが, 混乱の原因になるので, このノートでは用いない.  このノートでは「棄却された」「棄却されなかった」の組み合わせを一貫して使うことにする.)
