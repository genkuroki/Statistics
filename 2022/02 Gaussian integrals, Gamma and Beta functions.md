...
以下はDirichlet分布のヒートマップである. 明るい部分ほど確率密度が大きい. 正三角形は $t_1,t_2,t_3>0$, $t_1+t_2+t_3=1$ を表し, 右下, 上, 左下の頂点はそれぞれ $(t_1,t_2,t_3)=(1,0,0), (0,1,0), (0,0,1)$ に対応しており, 正三角形の中心の座標は $(1/2, 1/2, 1/2)$ になる.
