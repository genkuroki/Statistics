...
# %% [markdown] toc=true
# <h1>数理統計学2022目次<span class="tocSkip"></span></h1>
# <div class="toc"><ul class="toc-item"><li><span><a href="#目標" data-toc-modified-id="目標-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>目標</a></span></li><li><span><a href="#資料" data-toc-modified-id="資料-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>資料</a></span><ul class="toc-item"><li><span><a href="#01-Bernoulli試行と関連確率分布" data-toc-modified-id="01-Bernoulli試行と関連確率分布-2.1"><span class="toc-item-num">2.1&nbsp;&nbsp;</span>01 Bernoulli試行と関連確率分布</a></span></li><li><span><a href="#02-Gauss積分,-ガンマ函数,-ベータ函数" data-toc-modified-id="02-Gauss積分,-ガンマ函数,-ベータ函数-2.2"><span class="toc-item-num">2.2&nbsp;&nbsp;</span>02 Gauss積分, ガンマ函数, ベータ函数</a></span></li><li><span><a href="#03-確率分布達の解釈" data-toc-modified-id="03-確率分布達の解釈-2.3"><span class="toc-item-num">2.3&nbsp;&nbsp;</span>03 確率分布達の解釈</a></span></li><li><span><a href="#04-標本分布について" data-toc-modified-id="04-標本分布について-2.4"><span class="toc-item-num">2.4&nbsp;&nbsp;</span>04 標本分布について</a></span></li><li><span><a href="#05-大数の法則と中心極限定理" data-toc-modified-id="05-大数の法則と中心極限定理-2.5"><span class="toc-item-num">2.5&nbsp;&nbsp;</span>05 大数の法則と中心極限定理</a></span></li><li><span><a href="#06-条件付き確率分布,-尤度,-推定,-記述統計" data-toc-modified-id="06-条件付き確率分布,-尤度,-推定,-記述統計-2.6"><span class="toc-item-num">2.6&nbsp;&nbsp;</span>06 条件付き確率分布, 尤度, 推定, 記述統計</a></span></li><li><span><a href="#07-例" data-toc-modified-id="07-例-2.7"><span class="toc-item-num">2.7&nbsp;&nbsp;</span>07 例</a></span><ul class="toc-item"><li><span><a href="#07-1-例：ベータ函数と二項分布の関係とその応用" data-toc-modified-id="07-1-例：ベータ函数と二項分布の関係とその応用-2.7.1"><span class="toc-item-num">2.7.1&nbsp;&nbsp;</span>07-1 例：ベータ函数と二項分布の関係とその応用</a></span></li><li><span><a href="#07-2-Julia言語を使った統計学の勉強の仕方" data-toc-modified-id="07-2-Julia言語を使った統計学の勉強の仕方-2.7.2"><span class="toc-item-num">2.7.2&nbsp;&nbsp;</span>07-2 Julia言語を使った統計学の勉強の仕方</a></span></li></ul></li><li><span><a href="#08-P値と仮説検定と信頼区間(1)-一般論" data-toc-modified-id="08-P値と仮説検定と信頼区間(1)-一般論-2.8"><span class="toc-item-num">2.8&nbsp;&nbsp;</span>08 P値と仮説検定と信頼区間(1) 一般論</a></span></li><li><span><a href="#09-P値と仮説検定と信頼区間(2)-母比率" data-toc-modified-id="09-P値と仮説検定と信頼区間(2)-母比率-2.9"><span class="toc-item-num">2.9&nbsp;&nbsp;</span>09 P値と仮説検定と信頼区間(2) 母比率</a></span></li><li><span><a href="#10-P値と仮説検定と信頼区間(3)-母平均" data-toc-modified-id="10-P値と仮説検定と信頼区間(3)-母平均-2.10"><span class="toc-item-num">2.10&nbsp;&nbsp;</span>10 P値と仮説検定と信頼区間(3) 母平均</a></span></li><li><span><a href="#11-P値と仮説検定と信頼区間(4)-母比率の違い" data-toc-modified-id="11-P値と仮説検定と信頼区間(4)-母比率の違い-2.11"><span class="toc-item-num">2.11&nbsp;&nbsp;</span>11 P値と仮説検定と信頼区間(4) 母比率の違い</a></span><ul class="toc-item"><li><span><a href="#「P値と仮説検定と信頼区間(4)-母比率の違い」のノートブックの内容をJulia言語で直接実行するためのヒント" data-toc-modified-id="「P値と仮説検定と信頼区間(4)-母比率の違い」のノートブックの内容をJulia言語で直接実行するためのヒント-2.11.1"><span class="toc-item-num">2.11.1&nbsp;&nbsp;</span><strong>「P値と仮説検定と信頼区間(4) 母比率の違い」のノートブックの内容をJulia言語で直接実行するためのヒント</strong></a></span></li></ul></li><li><span><a href="#12-P値と仮説検定と信頼区間(5)-母平均の差" data-toc-modified-id="12-P値と仮説検定と信頼区間(5)-母平均の差-2.12"><span class="toc-item-num">2.12&nbsp;&nbsp;</span>12 P値と仮説検定と信頼区間(5) 母平均の差</a></span></li><li><span><a href="#13-誤用を避けるための注意" data-toc-modified-id="13-誤用を避けるための注意-2.13"><span class="toc-item-num">2.13&nbsp;&nbsp;</span>13 誤用を避けるための注意</a></span></li><li><span><a href="#14-回帰" data-toc-modified-id="14-回帰-2.14"><span class="toc-item-num">2.14&nbsp;&nbsp;</span>14 回帰</a></span></li><li><span><a href="#15-まとめ" data-toc-modified-id="15-まとめ-2.15"><span class="toc-item-num">2.15&nbsp;&nbsp;</span>15 まとめ</a></span></li></ul></li><li><span><a href="#参考資料" data-toc-modified-id="参考資料-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>参考資料</a></span><ul class="toc-item"><li><span><a href="#以上で解説できなかったことに関するノート" data-toc-modified-id="以上で解説できなかったことに関するノート-3.1"><span class="toc-item-num">3.1&nbsp;&nbsp;</span>以上で解説できなかったことに関するノート</a></span></li></ul></li></ul></div>
