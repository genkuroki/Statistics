...
* <a href="#09-p値と仮説検定と信頼区間2-比率">09 P値と仮説検定と信頼区間(2) 比率</a>
* <a href="#10-p値と仮説検定と信頼区間3-平均">10 P値と仮説検定と信頼区間(3) 平均</a>
* <a href="#11-p値と仮説検定と信頼区間4-比率の違い">11 P値と仮説検定と信頼区間(4) 比率の違い</a>
* <a href="#12-p値と仮説検定と信頼区間5-平均の差">12 P値と仮説検定と信頼区間(5) 平均の差</a>
