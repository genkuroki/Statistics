...
### 警告: 以上で紹介したWald版の比率の差に関するP値と信頼区間の精度は低い

以上で紹介したWald版の比率の差に関するP値と信頼区間の精度は低いので注意せよ. 改良の仕方が
